    ...
    <div class="quiz page">
        <div class="question-container fade-in" id="question-container" :data-question-id="question.id">
            ...
            <div class="question-options-container">
                <div class="option-container" :id="'option-container-'+index" :data-option-id="question.id" v-for="(option, index) in question.options" v-on:click="onNextQuestion(index)">
