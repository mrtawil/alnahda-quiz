...
@section('content')
    <div class="claim page">
        ...
        <div class="title">قهوة مجانية!</div>
        <div class="coupun">قسيمة رقم {{ $claim->id }}</div>
        <div class="description-1">التقط الشاشة</div>
        <div class="description-2">واظهرها للباريستا</div>
